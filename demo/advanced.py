...
if __name__ == '__main__':
    ...
    element = PixelElement(element_type=1, element_mask=static_font.num_3_mask, color_style=get_random_color_style((5, 5)))
    # 将元素放置于画布上
    pixel_canvas.put_element(element_name='3', element=element, layer=1, position=(1, 12))
    # 停顿一下
    time.sleep(1)
    # 改变一下元素位置
    pixel_canvas.change_element_position('3', (2, 15))
    time.sleep(1)
